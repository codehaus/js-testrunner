...
public class JSTestExecutionServerTest {
	...
	public void testGetCommandArgsWithDblQuotes() throws IOException {
		server.setCommandPattern("/Applications/phantomjs.app/Contents/MacOS/phantomjs \"%1$s'\" %2$s %3$s");
		...
		assertEquals("/testResults", args[2]);
		assertEquals("http:/a.html,http:/b.html", args[3]);
	}
